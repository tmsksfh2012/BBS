...
<body>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border:1px soid #dddddd">
				<thead>
					<tr>
			...
			%>
					...
					<a onclick="return confirm('삭제하시겠습니다?')" href="deleteAction.jsp?bbsID=<%= bbsID%>" class="btn btn-primary">삭제</a>
			<%
				}
			%>
